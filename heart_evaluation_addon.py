# ============================================================
# ADD THIS to "Multiple disease prediction system - heart.ipynb"
...
# (your original `LogisticRegression()` silently fails to fully
#  converge on this data -- this fixes a real, pre-existing bug)
# ============================================================
...
print(classification_report(Y_test, Y_test_pred, target_names=['Healthy', 'Heart Disease']))
